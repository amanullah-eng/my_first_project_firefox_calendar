...
//       // Localization Configuration (to be implemented)
//       // locale: const Locale('en', 'US'), // Default locale
//       // fallbackLocale: const Locale('en', 'US'),
//       // translations: AppTranslations(), // Implement translations class
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      initialRoute: _getInitialRoute(), // Dynamic initial route based on login status
      getPages: AppPages.routes,
      initialBinding: InitialBinding(),
...
class SessionManager {
  ...
  static Future<void> saveSession({
    ...
    final expiry = DateTime.now().add(sessionDuration ?? const Duration(days: 30));
