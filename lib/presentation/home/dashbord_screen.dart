  ...
  Widget _buildWelcomeCard(bool isDark) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Color(0xFFFF6B35).withOpacity(0.3), // soft orange shadow
            blurRadius: 8,
            offset: Offset(0, 4),
          ),
        ],
  ...
  Widget _buildMetricCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(14),
        border: Border.all(
          color: isDark ? AppColors.borderDark : Colors.black.withOpacity(0.10),
          width: 1.48,
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: const Color(0xFFFF6900).withOpacity(0.20),
            width: 1.48,
            strokeAlign: BorderSide.strokeAlignInside,
          ),
        ),
