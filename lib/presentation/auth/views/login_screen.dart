...
//         Container(
//           height: 100, // চাইলে 120, 140 করতে পারো
//           width: 250, // wide image এর জন্য width বেশি
...
class LoginScreen extends GetView<LoginController> {
  ...
  /// Build biometric button - converted from React component
  /// Matches: <Button onClick={handleBiometricLogin} variant="outline" size="icon" 
