...
class AppGradients {
  ...
  static LinearGradient get cardLight => LinearGradient(
    ...
    colors: [AppColors.cardLight, AppColors.mutedLight.withOpacity(0.3)],
  );
  ...
  static LinearGradient get cardDark => LinearGradient(
    ...
    colors: [AppColors.cardDark, AppColors.mutedDark.withOpacity(0.5)],
  );
  ...
  static LinearGradient get shimmerLight => LinearGradient(
    ...
    colors: [
      ...
      AppColors.mutedLight.withOpacity(0.1),
      AppColors.mutedLight.withOpacity(0.3),
    ],
  ...
  static LinearGradient get darkOverlay => LinearGradient(
    ...
    colors: [AppColors.transparent, AppColors.black.withOpacity(0.6)],
  );
  ...
  static LinearGradient get lightOverlay => LinearGradient(
    ...
    colors: [AppColors.transparent, AppColors.white.withOpacity(0.6)],
  );
